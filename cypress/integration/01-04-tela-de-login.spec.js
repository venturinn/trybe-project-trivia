...
describe('4 - [TELA DE LOGIN] Desenvolva testes para atingir 20% de cobertura total e 90% da tela de Login', () => {
  it('Verifica a cobertura de testes unitários', () => {
    cy.task('getCoverage', getId()).its('total.branches.pct', { timeout: 0 }).should('be.gte', 20.00);
