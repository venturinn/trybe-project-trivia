...
- [Requisitos do projeto](#requisitos-do-projeto)
    - [Tela de início/login](#tela-de-iníciologin)
      ...
      - [4. Desenvolva testes para atingir 20% de cobertura total e 90% da tela de Login](#4-desenvolva-testes-para-atingir-20-de-cobertura-total-e-90-da-tela-de-login)
    - [Tela de jogo](#tela-de-jogo)
      ...
      - [12. Desenvolva testes para atingir 60% de cobertura total e 90% da tela de Jogo](#12-desenvolva-testes-para-atingir-60-de-cobertura-total-e-90-da-tela-de-jogo)
    - [Tela de feedback](#tela-de-feedback)
      - [13. Desenvolva o header de _feedback_ que deve conter as informações da pessoa jogadora](#13-desenvolva-o-header-de-feedback-que-deve-conter-as-informações-da-pessoa-jogadora)
      - [14. Crie a mensagem de _feedback_ para ser exibida a pessoa usuária](#14-crie-a-mensagem-de-feedback-para-ser-exibida-a-pessoa-usuária)
      - [15. Exiba as informações relacionadas aos resultados obtidos para a pessoa usuária](#15-exiba-as-informações-relacionadas-aos-resultados-obtidos-para-a-pessoa-usuária)
      - [16. Crie a opção para a pessoa jogadora poder jogar novamente](#16-crie-a-opção-para-a-pessoa-jogadora-poder-jogar-novamente)
      - [17. Crie a opção para a pessoa jogadora poder visualizar a tela de _ranking_](#17-crie-a-opção-para-a-pessoa-jogadora-poder-visualizar-a-tela-de-ranking)
      - [18. Desenvolva testes para atingir 80% de cobertura total e 90% da tela de Feedbacks](#18-desenvolva-testes-para-atingir-80-de-cobertura-total-e-90-da-tela-de-feedbacks)
    - [Tela de ranking](#tela-de-ranking)
      - [19. Crie um botão para ir ao início](#19-crie-um-botão-para-ir-ao-início)
      - [20. Crie o conteúdo da tela de _ranking_](#20-crie-o-conteúdo-da-tela-de-ranking)
      - [21. Desenvolva testes para atingir 90% de cobertura total e 90% da tela de Ranking](#21-desenvolva-testes-para-atingir-90-de-cobertura-total-e-90-da-tela-de-ranking)
...
Isso acontece pois recentemente o redux passou a recomendar o uso da biblioteca `@redux/toolkit`que atualmente não ensimanos. 
...
#### 4. Desenvolva testes para atingir 20% de cobertura total e 90% da tela de Login
...
>Obs: Neste requisito vamos cobrir a nossa tela de login com testes unitários utilizando a biblioteca [React Testing Library](https://testing-library.com/docs/react-testing-library/intro/), aproveite essa oportunidade para colocar em prática o [Desenvolvimento Orientado por Testes](https://blog.betrybe.com/tecnologia/tdd-test-driven-development/)
  ...
  * Será validado se ao executar `npm test-coverage` é obtido os seguintes resultados:
      * `% Branch` da linha `All files` é maior ou igual a 20. 
...
#### 12. Desenvolva testes para atingir 60% de cobertura total e 90% da tela de Jogo
...
>Obs: Neste requisito vamos cobrir a nossa tela de Jogo com testes unitários utilizando a biblioteca [React Testing Library](https://testing-library.com/docs/react-testing-library/intro/), aproveite essa oportunidade para colocar em prática o [Desenvolvimento Orientado por Testes](https://blog.betrybe.com/tecnologia/tdd-test-driven-development/)
  ...
  **PRIORIDADE 2** - Cobertura de testes da tela de Jogo
...
#### 13. Desenvolva o header de _feedback_ que deve conter as informações da pessoa jogadora
...
#### 14. Crie a mensagem de _feedback_ para ser exibida a pessoa usuária
...
#### 15. Exiba as informações relacionadas aos resultados obtidos para a pessoa usuária
...
#### 16. Crie a opção para a pessoa jogadora poder jogar novamente
...
#### 17. Crie a opção para a pessoa jogadora poder visualizar a tela de _ranking_
...
#### 18. Desenvolva testes para atingir 80% de cobertura total e 90% da tela de Feedbacks
...
>Obs: Neste requisito vamos cobrir a nossa tela de Feedbacks com testes unitários utilizando a biblioteca [React Testing Library](https://testing-library.com/docs/react-testing-library/intro/), aproveite essa oportunidade para colocar em prática o [Desenvolvimento Orientado por Testes](https://blog.betrybe.com/tecnologia/tdd-test-driven-development/)
  ...
  * Será validado se ao executar `npm test-coverage` é obtido os seguintes resultados:
      * `% Branch` da linha `All files` é maior ou igual a 80. 
...
#### 19. Crie um botão para ir ao início
...
#### 20. Crie o conteúdo da tela de _ranking_
...
#### 21. Desenvolva testes para atingir 90% de cobertura total e 90% da tela de Ranking
...
>Obs: Neste requisito vamos cobrir a nossa aplicação com testes unitários utilizando a biblioteca [React Testing Library](https://testing-library.com/docs/react-testing-library/intro/), aproveite essa oportunidade para colocar em prática o [Desenvolvimento Orientado por Testes](https://blog.betrybe.com/tecnologia/tdd-test-driven-development/)
  ...
  * Será validado se ao executar `npm test-coverage` é obtido o seguinte resultado:
