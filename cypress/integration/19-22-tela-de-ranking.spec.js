...
describe('19 - [TELA DE RANKING] Crie um botão para ir ao início', () => {
...
describe('20 - [TELA DE RANKING] Crie o conteúdo da tela de _ranking_', () => {
  beforeEach(() => {
    cy.visit('http://localhost:3000/', {
      onBeforeLoad(win) {
        win.fetch = fetchMock;
...
describe('21 - [TELA DE RANKING] Desenvolva testes para atingir 90% de cobertura total e 90% da tela de Rankings', () => {
